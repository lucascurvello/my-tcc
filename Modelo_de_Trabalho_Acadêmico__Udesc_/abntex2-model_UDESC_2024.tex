...
% -----------------------------------------------------------------
\titulo{Estimação de Estado para Robôs quadrupedes}%

\autor{Lucas Araujo {} Curvello}%
...
\instituicao{Universidade do Estado de Santa Catarina, Centro de Ciências Tecnológicas, Departamento de Engenharia Elétrica}%
...
\preambulo{Projeto acadêmico apresentado como requisito parcial para aprovação da faculdade de Engenharia Elétrica da Universidade do Estado de Santa Catarina– Udesc– no Centro de Ciências Tecnológicas- CCT.}
...
%\include{Textuais/muse}
%\include{Textuais/fund_teo}
%\include{Textuais/hip_pes}
%\include{Textuais/Capitulo01}
%\include{Textuais/Capitulo02}
%\include{Textuais/Capitulo03}
\include{Textuais/01_Introducao}				% Capítulo 1
\include{Textuais/02_fund_rob_instru}
%\include{Textuais/03_est_estad_filt}
\include{Textuais/04_metodologia}
%\include{Textuais/05_resultados}
\include{Textuais/06_consideracoes}
% -----------------------------------------------------------------
